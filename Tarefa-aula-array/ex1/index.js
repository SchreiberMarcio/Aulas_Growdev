...
*/
// Lista de resoluções/metas de ano novo
let resolucoesAnoNovo = [
...
console.log(resolucoesAnoNovo[0]);

console.log(resolucoesAnoNovo[4]);

console.log(resolucoesAnoNovo[resolucoesAnoNovo.length - 1]);
